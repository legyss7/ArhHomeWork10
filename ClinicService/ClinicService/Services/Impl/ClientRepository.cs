    ...
    public class ClientRepository : IClientRepository
    {
        ...
        public int Create(Client item)
        {
            using (SqliteConnection connection = new SqliteConnection(connectionString))
            {
                ...
                command.CommandText = "INSERT INTO clients(Document, " +
                    "SurName, FirstName, Patronymic, Birthday) " +
                    "VALUES(@Document, @SurName, @FirstName," +
                    "@Patronymic, @Birthday)";
        ...
        public int Update(Client item)
        {
            using (SqliteConnection connection = new SqliteConnection(connectionString))
            {
                connection.Open();
                SqliteCommand command = connection.CreateCommand();
                command.CommandText = "UPDATE clients SET Document = @Document," +
                    "FirstName = @FirstName, SurName = @SurName," +
                    "Patronyminc = @Patronymic, Birthday = @Birthday" +
